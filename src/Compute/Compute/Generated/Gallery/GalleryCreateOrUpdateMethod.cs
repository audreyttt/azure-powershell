...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    public partial class NewAzureRmGallery : ComputeAutomationBaseCmdlet
    {
        public override void ExecuteCmdlet()
        {
            ...
            ExecuteClientAction(() =>
            {
                if (ShouldProcess(this.Name, VerbsCommon.New))
                {
                    ...
                    if (this.SystemAssignedIdentity.IsPresent || this.IsParameterBound(c => c.UserAssignedIdentity))
                    {
        ...
        [Parameter(
            Mandatory = false,
            HelpMessage = "Enables system-assigned identity for the gallery.")]
        public SwitchParameter SystemAssignedIdentity { get; set; }

        [Parameter(
            Mandatory = false,
            ValueFromPipelineByPropertyName = true,
            HelpMessage = "Specifies the resource IDs of user-assigned managed identities for the gallery as strings. Obtain these IDs from the 'Id' property of objects returned by 'Get-AzUserAssignedIdentity'.")]
