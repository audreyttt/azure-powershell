...
{
    [Cmdlet("Start", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AvailabilitySetMigration", DefaultParameterSetName = ResourceGroupNameParameterSet, SupportsShouldProcess = true)]
