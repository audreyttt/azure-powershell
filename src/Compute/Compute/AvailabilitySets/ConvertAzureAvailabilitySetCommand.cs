...
namespace Microsoft.Azure.Commands.Compute
{
    ...
    public class ConvertAzureAvailabilitySetCommand : AvailabilitySetBaseCmdlet
    {
        ...
        [Parameter(
            Mandatory = false,
            ValueFromPipelineByPropertyName = true,
            HelpMessage = "The name of the new Virtual Machine Scale Set to create and migrate the Availability Set Virtual Machines into.")]
        [ValidateNotNullOrEmpty]
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (this.ShouldProcess(Name, "Convert"))
            {
                ExecuteClientAction(() =>
                {
                    string vmssName = this.IsParameterBound(c => c.VirtualMachineScaleSetName) ? this.VirtualMachineScaleSetName : null;
