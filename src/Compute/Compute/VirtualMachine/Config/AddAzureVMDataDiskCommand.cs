...
namespace Microsoft.Azure.Commands.Compute
{
    ...
    public class AddAzureVMDataDiskCommand : ComputeClientBaseCmdlet
    {
        ...
        [Parameter(
            Mandatory = false,
            ValueFromPipelineByPropertyName = true,
            HelpMessage = "Specifies the Read-Write IOPS for the managed disk. Should be used only for UltraSSD_LRS or PremiumV2_LRS disks.")]
        public long? DiskIOPSReadWrite { get; set; }

        [Parameter(
            Mandatory = false,
            ValueFromPipelineByPropertyName = true,
            HelpMessage = "Specifies the bandwidth in MB per second for the managed disk. Should be used only for UltraSSD_LRS or PremiumV2_LRS disks.")]
