...
Converts an Availability Set to a new Flexible Virtual Machine Scale Set without downtime.
...
Migrates a Virtual Machine to a Flexible Virtual Machine Scale Set.
...
Starts the migration of an Availability Set to a Flexible Virtual Machine Scale Set.
...
Cancels an ongoing Availability Set migration to a Flexible Virtual Machine Scale Set.
...
Validates that Virtual Machines in an Availability Set can be migrated to a Flexible Virtual Machine Scale Set.
